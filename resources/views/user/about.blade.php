            ...
            <div class="row align-items-center justify-content-center">
                <div class="mb-4 col-lg-5 col-md-6 mb-md-0">
                    <div class="image-wrapper">
                        <img class="img-fluid w-100" src="https://samidhalpur.xyz/storage/img/set/pr_img.jpg">
                    </div>
                </div>
                <div class="col-lg-5 col-md-6">
                    <div class="pl-0 content pl-lg-3">
                        @php $set = DB::table('settings')->first() @endphp
                        <h2 id="helllo-im-richi-andorn-im-a-biography-based-researcher-and-author">Helllo {{$set->about_title}}</h2>
                        <p>{{$set->about_subtitle}}</p>
                    </div>
                </div>
            </div>
        </div>
